...
core_floor_bac <- core(bac_split$Floor, corte_prev = 0.15, corte_abund = 0.00)
core_wall_bac <- core(bac_split$Wall, corte_prev = 0.15,corte_abund = 0.00)
core_scalp_bac <- core(bac_split$Scalp, corte_prev = 0.15,corte_abund = 0.00)
...
```{r}
#selecionar os core members
core_floor_fun <- core(fun_split$Floor, corte_prev = 0.15, corte_abund = 0.00)
core_wall_fun <- core(fun_split$Wall, corte_prev = 0.15,corte_abund = 0.00)
core_scalp_fun <- core(fun_split$Scalp, corte_prev = 0.15,corte_abund = 0.00)
#filtrar os dados originais para manter apenas os core members no formato phyloseq
